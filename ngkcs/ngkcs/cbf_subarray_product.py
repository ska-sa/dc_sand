...
class CBFSubarrayProductBase:
    ...
    def __init__(self, 
        ...
        self._device_status_sensor = cbf_servlet.sensors['device-status']
    ...
    def add_sensor(self, sensor: Sensor) -> None:
        ...
        # self.cbf_servlet.sensors.add(sensor)
    ...
    def remove_sensors(self):
        ...
        #     self.cbf_servlet.sensors.discard(sensor)
        self.sensors.clear()
...
class CBFSubarrayProductInterface(CBFSubarrayProductBase):
    """Dummy implementation of CBFSubarrayProductBase interface that does not
    ...
    async def configure_impl(self) -> None:
        ...
        self._interface_mode_sensors.add_sensors(self.cbf_servlet)
    ...
    async def deconfigure_impl(self, force: bool, ready: asyncio.Event) -> None:
        self._interface_mode_sensors.remove_sensors(self.cbf_servlet)
