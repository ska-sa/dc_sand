                                ...
                                float* pfCplxSteeringCoeffs)
{
    ...
    if(iInterChannelIndex < NR_BEAMS*NR_STATIONS){
        ...
        float fTimeDifference = sCurrentTime.tv_sec - cRefTime.tv_sec;
        long fNanosecondsTimeDifference = sCurrentTime.tv_nsec - cRefTime.tv_nsec;
