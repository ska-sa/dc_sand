...
def calculate_distances_km(src, dest):
    ...
    This calculates the distance between two coordinates. It projects the distance onto the equator and returns this 
    as well. I thought this projection was important for delay tracking, but the baseline distance is more applicable. 
    However the calculation has been left here due to laziness.
...
print(f"Multiply by three to account for PPS propagation and virtual reference antenna: {max_coarse_delay_s*1000*1000*3:.2f} us")
