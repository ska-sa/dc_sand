...
do  
    ...
    echo $timestamp
    sudo chrt 50 numactl -N 0 -C 0 ./udp_receive -t ${clients} -n ${num_tests} -d ${delay_us} -w ${window_length_us} -o StressTest_${timestamp}_N${num_tests}_W${window_length_us}_D${delay_us}_T${clients} -p
